...
class Item extends React.Component{
    ...
    render() {
        const {checkIn,checkOut,date,user_name,overtime,attendance,type} = this.props;       
        return( 
            ...
            <View style={{paddingBottom:hp('1%'),marginBottom:hp('3%')}} >
              ...
              {/* <View style={{marginLeft:wp('3%'),paddingTop:hp('2%')}}> */}
                <View style={{flexDirection:'row'}}>
                <Text style={{marginLeft:wp('2%'),fontWeight:'bold'}} numberOfLines={1}> Date:   </Text>
                <Text style={{marginLeft:wp('2%')}} numberOfLines={1}> {date}   </Text>
              </View>
